// glslv profile log:
// <stdin>(19) : warning C7050: "$ATTR8" might be used before being initialized
// <stdin>(18) : warning C7050: "$ATTR10" might be used before being initialized
// <stdin>(17) : warning C7050: "$ATTR9" might be used before being initialized
// 55 lines, 3 warnings, 0 errors.

// glslf profile log:
// <stdin>(51) : warning C7011: implicit cast from "float4" to "float3"
// <stdin>(51) : warning C7011: implicit cast from "float4" to "float3"
// 55 lines, 2 warnings, 0 errors.
...
void main()
{
    ...
    gl_TexCoord[1].xyz = _TMP18;
    gl_TexCoord[3].xyz = _r0013.xyz;
    gl_TexCoord[4].xyz = _r0015.xyz;
...
void main()
{
    ...
    _bump = (texture2D(NormalSampler, gl_TexCoord[0].xy).xy*2.00000000E+000 - 1.00000000E+000)*BumpHeight;
    _x0016 = dot(gl_TexCoord[2].xyz, gl_TexCoord[2].xyz);
    _TMP11 = inversesqrt(_x0016)*gl_TexCoord[2].xyz;
    _x0022 = dot(gl_TexCoord[3].xyz, gl_TexCoord[3].xyz);
    _TMP17 = inversesqrt(_x0022)*gl_TexCoord[3].xyz;
    _x0028 = dot(gl_TexCoord[4].xyz, gl_TexCoord[4].xyz);
    _TMP23 = inversesqrt(_x0028)*gl_TexCoord[4].xyz;
    _nb = _TMP11 + _bump.x*_TMP17 + _bump.y*_TMP23;
    _x0034 = dot(_nb, _nb);
    _TMP29 = inversesqrt(_x0034)*_nb;
    _x0040 = dot(gl_TexCoord[1].xyz, gl_TexCoord[1].xyz);
    _TMP35 = inversesqrt(_x0040)*gl_TexCoord[1].xyz;
